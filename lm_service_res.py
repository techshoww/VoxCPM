...
model_instance = MiniCPMModel_AXInfer(residual_lm_config, f"../../VoxCPM.Axera/model_convert/residual_lm-axmodels/", 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=9003, help='Port number to bind to')
