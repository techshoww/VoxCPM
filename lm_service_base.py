...
model_instance = MiniCPMModel_AXInfer(config.lm_config, f"../../VoxCPM.Axera/model_convert/base_lm-axmodels/", 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=9002, help='Port number to bind to')
