...
model_instance = MiniCPMModel_AXInfer(encoder_config, f"../../VoxCPM.Axera/model_convert/feat_encoder_encoder-axmodels/", 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=9001, help='Port number to bind to')
